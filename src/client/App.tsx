		...
		return (
			<div style={{height: "100%", display: "flex", flexDirection: "column"}}>
				...
				<div className="footer">
					<a target="_blank" href="https://github.com/Longwelwind/majority">Open-source</a> reimplementation by
					<a target="_blank" href="https://longwelwind.net/">Longwelwind</a> of the game
